            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, conexao
                            ...
                            console.log("Erro na aplica\u00E7\u00E3o ".concat(er));
                        })];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    console.log("Erro encontrado ".concat(error_1));
                    return [3 /*break*/, 3];
...
exports.novaBaseConnection = novaBaseConnection;
